...
$sql = "SELECT id, product_id, detail_id, priority FROM list_for_workers
ORDER BY 
    CASE 
...
<html lang="ru">
  <head>
    ...
    />
    <title>Составление списков для сборки</title>
    <style>
      * {
        margin: 0;
        padding: 0;
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_lists.php?id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Изменить последовательность</a>
